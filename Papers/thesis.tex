...
$ F : {\mathbb{Z}_{2^k}^{n^2}} \mapsto [0, 1] $, where k is the bit-width of the pixels and n is the side-length of the image in pixels. This provides a natural candidate for use as a fitness function.
\par The tester bot goes through each solution of pixels and evaluates 
